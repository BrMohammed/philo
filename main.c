...
/*   Updated: 2022/03/27 17:08:43 by brmohamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_msg(char* word,var_t *my_var,int philo_number)
{
...
void threads(pthread_t *th,pthread_t wth,var_t *var)
{
	int i;
...
void parse(pthread_t *th,pthread_t wth,var_t *var)
{
	int i;
